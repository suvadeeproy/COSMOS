...
st.set_page_config(page_title="COSMOS — Scientific ML (Ready v2)", layout="wide")
st.title("COSMOS — Unified Scientific ML Workbench (Ready v2)")
st.caption("Hardened build · Optional real data · Robust static paths")
